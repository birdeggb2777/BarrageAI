...
while (EndCheck==0):
    ...
    for i in range(0,AllBall,power):      
        ...
        if Balltimes>=(i)*power:
            ...
            if They_Array[i].they_X>=My_X-20 and They_Array[i].they_X<=My_X+1 and They_Array[i].they_Y>=My_Y-20 and They_Array[i].they_Y<=My_Y+1:
                EndCheck=1
                final=2
            if They2_Array[i].they_X>=My_X-20 and They2_Array[i].they_X<=My_X+1 and They2_Array[i].they_Y>=My_Y-20 and They2_Array[i].they_Y<=My_Y+1:
                EndCheck=1
                final=2
        else:
